...
```
By default, punctual uses a brightness value of `1` so you can get away without specifying it (try it!)
```
circle [0] 0.25 >> video;
```

You can reduce the brightness by half by changing the `1` to `0.5`
```
...
![sine oscillator animation](https://i.pinimg.com/originals/21/22/cd/2122cd39bfb486e56c79a4350be2f9cf.gif)
