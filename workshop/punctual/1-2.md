...
In Punctual, the numbers that are generated/passed to the output to light a pixel default to full brightness ie:

> should I be On (full brightness) or Off (black)?
