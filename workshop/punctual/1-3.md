...
4. In our `alpha` example, we subtracted a `circle` from a `blue` screen - can you think of a way to invert this effect (ie subtract all the `blue` **except** the circle)? 
